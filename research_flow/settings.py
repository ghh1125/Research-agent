...
class RuntimeSettings:
    ...
    dashscope_model: str
    dashscope_quick_model: str
    dashscope_deep_model: str
...
def get_settings() -> RuntimeSettings:
    load_env()
    fallback = tuple(item.strip().lower() for item in _first("LLM_FALLBACK_PROVIDERS", "RESEARCH_AGENT_LLM_FALLBACK_PROVIDERS").split(",") if item.strip())
    return RuntimeSettings(
        llm_provider=_first("LLM_PROVIDER", "RESEARCH_AGENT_LLM_PROVIDER", default="auto").lower(),
        llm_fallback_providers=fallback,
        llm_timeout_seconds=float(_first("LLM_TIMEOUT_SECONDS", "RESEARCH_AGENT_LLM_TIMEOUT_SECONDS", default="60")),
        ...
        openai_quick_model=_first("OPENAI_QUICK_MODEL", default=""),
        openai_deep_model=_first("OPENAI_DEEP_MODEL", default=""),
        ...
        dashscope_quick_model=_first("DASHSCOPE_QUICK_MODEL", default=""),
        dashscope_deep_model=_first("DASHSCOPE_DEEP_MODEL", default=""),
        ...
        sec_user_agent_email=_first("SEC_USER_AGENT_EMAIL", default="research-agent@example.com"),
    )
